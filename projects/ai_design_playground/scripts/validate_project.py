...
def validate_optional_inputs(context: ValidationContext, config) -> None:
    ...
    if raw_files:
        ...
        context.add("raw_inputs", "WARN", "no raw input files yet; project can generate toy inputs at runtime")
    ...
    if reference:
        ...
        context.add("reference_genome", "WARN", "REFERENCE_GENOME is not configured for this project")
