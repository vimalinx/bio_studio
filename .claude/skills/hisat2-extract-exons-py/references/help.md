# hisat2-extract-exons-py Help Reference

- Command: `hisat2_extract_exons.py`
...
```text
$ hisat2_extract_exons.py --version
usage: hisat2_extract_exons.py [-h] [-v] [gtf_file]
hisat2_extract_exons.py: error: unrecognized arguments: --version
```

## Captured Help

```text
$ hisat2_extract_exons.py --help
usage: hisat2_extract_exons.py [-h] [-v] [gtf_file]
