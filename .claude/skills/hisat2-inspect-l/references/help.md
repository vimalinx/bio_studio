# hisat2-inspect-l Help Reference

- Command: `hisat2-inspect-l`
...
```text
$ hisat2-inspect-l --version
hisat2-inspect-l version 2.2.2
64-bit
...
Usage: hisat2-inspect [options]* <ht2_base>
  <ht2_base>         ht2 filename minus trailing .1.ht2l/.2.ht2l
...
Options:
  ...
  --exon             Print exons
  -e/--ht2-ref       Reconstruct reference from .ht2l (slow, preserves colors)
...
*** Warning ***
'hisat-inspect' was run directly.  It is recommended to use the wrapper script instead.
```
