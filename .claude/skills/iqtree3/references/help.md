# iqtree3 Help Reference

- Command: `iqtree3`
- Sources: conda_bioconda
- Local executable: `/home/vimalinx/miniforge3/envs/bio/bin/iqtree3`
- Summary: CLI installed by bioconda package iqtree.
- Package names: iqtree
...
MODEL-FINDER:
  --use-nn-model       Use neural network for tree inference
  --nn-path-model      Neural network file for substitution model (onnx format)
  --nn-path-rates      Neural network file for alpha value (onnx format)
...
GENOMIC EPIDEMIOLOGICAL ANALYSIS:
  ...
  --alrt <num_rep>     Specify number of replicates to compute SH-aLRT.
  ...
  -T <num_thread>      Specify number of threads used for computing
                       branch supports (SH-aLRT or SPRTA).
