# hisat2-align-l Help Reference

- Command: `hisat2-align-l`
...
```text
$ hisat2-align-l --version
hisat2-align-l version 2.2.2
64-bit
...
```text
$ hisat2-align-l --help
HISAT2 version 2.2.2 by Daehwan Kim (infphilo@gmail.com, www.ccb.jhu.edu/people/infphilo)
Usage: 
  hisat2-align [options]* -x <ht2-idx> {-1 <m1> -2 <m2> | -U <r>} [-S <sam>]

  <ht2-idx>  Index filename prefix (minus trailing .X.ht2l).
