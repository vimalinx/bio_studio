# bowtie2-build-s Help Reference

- Command: `bowtie2-build-s`
...
bowtie2-build-s version 2.5.5
64-bit
Built on runnervmn36qa
Tue Feb 17 04:31:16 UTC 2026
...
*** Warning ***
'bowtie2-build-s' was run directly.  It is recommended that you run the wrapper script 'bowtie2-build' instead.
```
