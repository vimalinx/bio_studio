# hisat2-build-l Help Reference

- Command: `hisat2-build-l`
...
```text
$ hisat2-build-l --version
hisat2-build-l version 2.2.2
64-bit
...
Usage: hisat2-build [options]* <reference_in> <ht2_index_base>
    ...
    hisat2_index_base       write ht2l data to files with this dir/basename
Options:
...
*** Warning ***
'hisat2-build-l' was run directly.  It is recommended that you run the wrapper script 'hisat2-build' instead.
```
