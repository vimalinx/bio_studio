    ...
    def configure(self, self_critic=False, test_time_scale_round=0):
        ...
        def execute(state: AgentState) -> AgentState:
            ...
            if execute_match:
                ...
                # Use HumanMessage instead of AIMessage to avoid consecutive assistant messages
                # This is required for some APIs like DeepSeek that don't allow consecutive assistant messages
